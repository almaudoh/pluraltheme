...
body.sidebars #main-content { margin: 0 0 0 -{$totalwidth}px; }
body.sidebar-left #main-content { margin-left: -{$leftwidth}px; }
body.sidebar-right #main-content { margin-left: -{$rightwidth}px; }
body.sidebars #squeeze { margin: 0 0 0 {$totalwidth}px; }
body.sidebar-left #squeeze { margin-left: {$leftwidth}px; }
body.sidebar-right #squeeze { margin-left: {$rightwidth}px; }
#middle-wrapper .region-sidebar-left { width: {$leftwidth}px; }
#middle-wrapper .region-sidebar-right { width: {$rightwidth}px; }
body.sidebars .region-sidebar-left .block { margin: 10px 0 10px 0; }
body.sidebars .region-sidebar-right .block { margin: 10px 10px 10px 10px; }
body.sidebar-left .region-sidebar-left .block { margin: 10px 10px 10px 0; }
body.sidebar-right .region-sidebar-right .block { margin: 10px 10px 10px 0; }
EOF;
