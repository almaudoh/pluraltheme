...
<?php } ?>
body.sidebars #main-content { margin: 0 -<?php echo $rightwidth ?>px 0 -<?php echo $leftwidth ?>px; }
...
body.sidebars #squeeze { margin: 0 <?php echo $rightwidth ?>px 0 <?php echo $leftwidth ?>px; }
