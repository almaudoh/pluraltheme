...
namespace Drupal\pluraltheme\Plugin\Block;
 ...
 *
 * @Block(
 *   id = "circled_icon_block",
 *   admin_label = @Translation("Circled icon")
 * )
 */
class CircledIconBlock extends BlockBase implements ContainerFactoryPluginInterface {
